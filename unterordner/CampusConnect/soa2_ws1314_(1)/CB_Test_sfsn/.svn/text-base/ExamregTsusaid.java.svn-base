...
public class ExamregTsusaid extends com.softwareag.entirex.aci.Tester2 {

	protected void setFields() {
		addField("1  #STUDENTID (P9)",false,true,4,"susaid_studentid");
	}

	public static void main(String[] args) {
		new ExamregTsusaid().test(args, Examreg.class, "susaid");
	}
}
