...
public class ExamregTstp extends com.softwareag.entirex.aci.Tester2 {

	protected void setFields() {
		addField("1  #STUDENTID (P9)",true,false,1,"1");
		addField("1  #MESSAGE (A40)",false,true,4,"stp_message");
	}

	public static void main(String[] args) {
		new ExamregTstp().test(args, Examreg.class, "stp");
	}
}
