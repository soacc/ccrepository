...
public class ExamregTsem extends com.softwareag.entirex.aci.Tester2 {

	protected void setFields() {
		addField("1  #EXAMID (P9)",true,false,1,"1");
		addField("1  #PROFESSORID (P9)",true,false,1,"2");
		addField("1  #EXAMDATE (A32)",true,false,1,"3");
		addField("1  #EXAMTIME (A32)",true,false,1,"4");
		addField("1  #EXAMROOM (A32)",true,false,1,"5");
		addField("1  #MESSAGE (A40)",false,true,4,"sem_message");
	}

	public static void main(String[] args) {
		new ExamregTsem().test(args, Examreg.class, "sem");
	}
}
