...
public class Lf010_loadfilteredcoursesdefaultviewview  extends   com.webmethods.caf.faces.bean.BasePageBean {
	...
	private static final String[][] LF010_LOADFILTEREDCOURSES_PROPERTY_BINDINGS = new String[][] {
		{"#{lf010_loadfilteredcourses.course}", "#{Lf010_loadfilteredcoursesdefaultviewview.lf010_loadfilteredcourses.course}"},
	};
	/**
	 * Initialize page
	 */
